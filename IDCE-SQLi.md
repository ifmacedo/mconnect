...
DBMS usually is an Oracle, but you could have to find out the DBMS whether it was changed. For this, you could execute the following command:
sqlmap -r idce-sqli.txt --dbs --level=5 --risk=3 --technique=T

If you do not have success with the Time-Based techniques, try all other possible techquines with the following command:
